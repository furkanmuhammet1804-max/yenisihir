...
- Performans: tam ekran video, gizli giriş yöntemleri:
  - **Grid (karartmasız / karartmalı)** — görünmez 3×3 veya 4×3 tuş takımı
  ...
  - **Çizim** — alt kenara uzun bas → silik çizim alanı, çift dokunuş onay
...
- Gizli jestler (seyirciye tamamen görünmez):
  - **Çıkış:** sol üst köşeye **2 sn** uzun bas.
